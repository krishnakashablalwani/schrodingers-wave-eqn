...
c1 = 1 / np.sqrt(2)
c2 = 1 / np.sqrt(2)
# initial wavefunctions and energies
psi1 = psi(1, x)
psi2 = psi(2, x)
E1 = energy(1)
E2 = energy(2)
...
# plot initial wavefunction components
...
def setup_electron_cloud_window():
    ...
    root.bind(
        "<Return>", lambda event: update_visualization(n_entry.get(), canvas, n_label)
    )
